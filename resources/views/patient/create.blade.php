...
<body>
    <div class="C-container">
        ...
        <div class="form-container1">
            <form action="{{ isset($patient) ? route('patient.update', $patient->id) : route('patient.store') }}"
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="name" name="name" required
                        value="{{ isset($patient) ? $patient->name : '' }}" autofocus>
                </div>
                ...
                <div class="form-group">
                    <div class="select-box">
                        ...
                        <select id="gender" required name="gender">
                            <option value="{{isset($patient) ? $patient->Gender : ""}}">
                                {{isset($patient) ? $patient->Gender : "حدد الجنس"}}</option>
                            <option value="male" {{ isset($patient) && $patient->gender == 'male' ? 'selected' : '' }}>ذكر
                            </option>
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="oldSurgery" name="oldSurgery"
                            value="{{ isset($patient) ? $patient->oldSurgery : '' }}">
                    </div>
                    <div class="form-group">
                        <label for="alirgy">حساسية</label>
                        <input type="text" id="alirgy" name="alirgy"
                            value="{{ isset($patient) ? $patient->alirgy : '' }}">
                    </div>
                    <div class="form-group">
                        <label for="disease">مرض مزمن</label>
                        <input type="text" id="disease" name="disease"
                            value="{{ isset($patient) ? $patient->disease : '' }}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="permenantCure" name="permenantCure"
                            value="{{ isset($patient) ? $patient->permenantCure : '' }}">
                    </div>
                    <div class="form-group">
                ...
                <div class="form-group">
                    <div class="kok">
                        <div class="bok">
                            ...
                            <input type="file" id="profile-image" name="profile-image" class="file-input"
                        ...
                        @if(isset($patient) && $patient->Field)
                            @foreach($patient->Field as $field)
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="dynamicFieldValue[]" value="{{ $field->value }}"
                ...
                <br>
                <button type="submit" class="save-btn">{{isset($patient) ? 'عدّل' :'أنشئ'}}</button>
                <br>
            </form>
        </div>
        <div class="boton">
