...
<body>
    ...
    <div class="all">
        <div class="container">
            ...
            <br>
            <form action="{{ route('patient.index') }}" method="GET" style="display: flex; gap: 10px;">
                <input type="text" name="search" id="searchInput" placeholder="Search..." style="width:15vw"
            ...
            <div class="table-container">
                ...
                <table id="patientTable">
                    <thead>
                        <tr>
                            <th onclick="sortTable('id')" style="cursor: pointer">ID <span id="arrow-id"
                                    class="circle inactive"></span></th>
                            <th onclick="sortTable('name')" style="cursor: pointer">الاسم <span id="arrow-name"
                                    class="circle inactive"></span></th>
                            <th>الرقم</th>
                            <th>العنوان</th>
                            ...
                            <th>العمر</th>
                            <th>الوظيفة</th>
                            <th onclick="sortTable('createdAt')" style="cursor: pointer">تاريخ الإضافة <span
                                    id="arrow-created-at" class="circle inactive"></span></th>
                            <th> آخر تعديل</th>
                            <th>تفاصيل</th>
                        </tr>
                    </thead>
                        ...
                        @foreach ($patients as $patient)
                                ...
                                <tr>
                                    ...
                                    <td class="action-td">
                                        ...
                                        <form id="deleteForm" action="{{ route('patient.destroy', $patient->id) }}"
                                        ...
                                        <div id="confirm-modal" class="modal" style="display: none;">
                                            <div class="modal-content"
                                                style="background-color: #4e9dec; color: white; padding: 15px; border-radius: 5px; position: fixed; left: 50%; top: 50%; transform: translate(-50%, -50%); width: 300px; text-align: center;">
                                                <p>Are you sure you want to delete this patient?</p>
                                                <p style="font-weight: bold; color: rgb(0, 0, 0);">Warning: all the patient data
                                                    will be deleted</p>
                                                <div style="display: flex; justify-content: center;">
                                                    <button onclick="closeModal()"
                                                        style="background-color: transparent; border:black; color: white; margin-right: 10px;">Cancel</button>
                                                    <button onclick="deletePatient()"
                                                        style="background-color: transparent; border:black ; color: white; font-weight: bold;">Delete</button>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="custom-pagination">
                    ...
                    @if ($patients->onFirstPage())
                        <button class="page-btn" disabled>
                            <<
                    @else
                        <a href="{{ $patients->previousPageUrl() }}" class="page-btn">
                            <<
                    @endif
