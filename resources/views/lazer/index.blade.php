...
<body>
    ...
    <div class="C-container">
        <h1>قسم الليزر</h1>
        <form action="{{ isset($lazer) ? route('lazer.update', $lazer->id) : route('lazer.store') }}" method="POST"
                        ...
                        @if(isset($existingDetails) && count($existingDetails) > 0)
                            @foreach($existingDetails as $detail)
                                <tr class="row">
                                    ...
                                    <td>
                                        <button type="button" class="action-btn delete-btn">حذف</button>
                                    </td>
                                </tr>
                            @endforeach
                        @endif
            ...
            @isset($lazer)
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="real_price" name="real_price"
                        value="{{isset($lazer) ? $lazer->real_price : ''}}">
                </div>
...
<script>
    ...
    <script>
        ...
        document.getElementById('addRowBtn').addEventListener('click', function () {
            ...
            // Re-attach listeners after adding a new row
